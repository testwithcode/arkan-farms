    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 lg:ml-64 overflow-y-auto bg-[#0A0B09]">
        <div className="p-6 lg:p-8 space-y-8">
          <div>
            <h1 className="text-4xl lg:text-5xl font-light text-white mb-2 font-['Outfit']" data-testid="feed-selection-title">
              {t('feedManagement')}
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {farms.map((farm, index) => (
              <button
                key={farm.id}
                onClick={() => navigate(`/feed/${farm.id}`, { state: { farm } })}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-white/60 text-sm">View feed management</p>
                </div>
              </button>
            ))}
          </div>
